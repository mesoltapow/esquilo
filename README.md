...
<body>
    <header class="container text-center">
        <img src="https://conteudo.imguol.com.br/2012/09/18/o-esquilo-mais-dramatico-da-internet-1347997530800_300x300.jpg.webp" alt="avatar da felipe" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou o felipe</p>
        <h1>Eu tento aprender programação</h1>
        <p>Sou do 3°ano de exatas do ensino medio, e estou aprendendo programação,tenho como objetivo seguir na area de arquitetura e design</p>
    ...
    <main class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFCxMJEpg-HybwJCOVqLrdzwMA8bM0xBDY_Q&s" class="card-img-top" alt="Imagem do projeto de biblioteca virtual">
                    <div class="card-body">
                        <h5 class="card-title">projeto scratch: jogo do pacman</h5>
                        <p class="card-text">Este projeto é um jogo que mostra os niveis quando você passa deles,a pontuação e o volume do jogo.
                        </p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="https://mesoltapow.github.io/paolinha69/" class="card-img-top" alt="Imagem do projeto de biblioteca virtual">
                    <div class="card-body">
                        <h5 class="card-title">projeto html: Site alice no pais das maravilhas</h5>
                        <p class="card-text">Este projeto é um site sobre alice no pais das maravilhas, contando sobre os personagens principais a entrodução do filme e um video.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRL3utN8BFyCyNKEi912bifndCOUriJ0ihdCw&s" class="card-img-top" alt="Imagem do projeto de biblioteca virtual">
                    <div class="card-body">
                        <h5 class="card-title">projeto javascript: jogo de corrida
                        </h5>
                        <p class="card-text">esse projeta javascript mostra um jogo de corrida que precisa desviar dos carros, mostrando a velocidade do carro e os pontos feito por passagem de carros.
                        </p>
